        ...
        <div style={{
          ...
          <div style={{ marginBottom: 16, paddingBottom: 12, borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
            ...
            <input
              ...
              max={100}
              value={pinchL}
              onChange={(e) => setPinchL(parseInt(e.target.value))}
              style={{ width: '100%' }}
            />
          </div>
          ...
          <div style={{ marginBottom: isAdvanced ? 16 : 0, paddingBottom: isAdvanced ? 12 : 0, borderBottom: isAdvanced ? '1px solid rgba(255,255,255,0.1)' : 'none' }}>
            ...
            <input
              ...
              max={100}
              value={pinchR}
              onChange={(e) => setPinchR(parseInt(e.target.value))}
              style={{ width: '100%' }}
            />
          </div>
            ...
            <div style={{ marginTop: 12 }}>
              ...
              <div style={{ marginBottom: 8 }}>
                ...
                <input
                  ...
                  max={100}
                  value={handUL}
                  onChange={(e) => setHandUL(parseInt(e.target.value))}
                  style={{ width: '100%' }}
                />
              </div>
              ...
              <div style={{ marginBottom: 8 }}>
                ...
                <input
                  ...
                  max={100}
                  value={handUR}
                  onChange={(e) => setHandUR(parseInt(e.target.value))}
                  style={{ width: '100%' }}
                />
              </div>
              ...
              <div style={{ marginBottom: 8 }}>
                ...
                <input
                  ...
                  max={100}
                  value={handLL}
                  onChange={(e) => setHandLL(parseInt(e.target.value))}
                  style={{ width: '100%' }}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  max={100}
                  value={handLR}
                  onChange={(e) => setHandLR(parseInt(e.target.value))}
                  style={{ width: '100%' }}
                />
              </div>
            </div>
